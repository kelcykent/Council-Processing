...
title: "Council BASE gapfilling with ERA5 with Kyle" #Here we are tweaking the ERA5 data to match the half-hourly format of the Ameriflux data and gapfilling those half hours from the Ameriflux BASE dataset. (Might be slightly different it you're using the Ameriflux Fullset dataset*)
output: html_document
date: "2024-09-16"
---

#Notes: ERA5 is a climate model we use to gap-fill -- we use GoogleEarth Engine to download the maps for our specific location (see Kyle about this / Kyle will teach us and share the code for that later). We need to reformat the ERA5 model data so it matches well with the Ameriflux datafile so we can use it go gapfill in later steps. 
...
setwd("~/Council Data/Council BASE gapfilling") #C:/Users/kkent/Documents/Council Data/Council BASE gapfilling

 
getwd()
```
#Load Council Ameriflux BASE dataset 

```{r}
#Ameriflux HH data for council 2017 - 2023, half hourly 
# df = fread(input = "C:/Users/kkent/Documents/Council Data/Council BASE gapfilling/AMF_US-NGC_BASE_HH_2-5.csv", na.strings = c('-9999','NA','NaN','NAN','-7999'))

#Redoing with re-cleaned Data from Dani (10.28.2024)
df = fread(input = "C:/Users/kkent/Documents/Council Data/Council BASE gapfilling/councilbase_met_flux_clean_2017_2023.csv", na.strings = c('-9999','NA','NaN','NAN','-7999'))


#ERA5 df used for gapfilling 2016 - 2023, hourly
ERA5 = fread(input = "C:/Users/kkent/Documents/Council Data/Council BASE gapfilling/ERA5hourly_2016_2023_Council.csv", na.strings = c('-9999','NA','NaN','NAN','-7999'))
```


# start of coding with Kyle on 9.16.2024
...
#Read in the full ERA5 dataset, which is the ERA5 hourly datatset for Council from 2016 - 2023
...
>>>>>>> 3c1625ffa6d9d0e5e1765c070ef1bcb94d0e4780
